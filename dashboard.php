...
<html lang="en">
  <head>
    ...
    <!--Link to Google Fonts: Inter, Fondamento, Cormorant Garamond-->
    ...
    <div class="dashboard-container">
      ...
      <aside class="sidebar expanded">
        <div class="sidebar-header">
          <img
            src="assets/images/Talmidēo Logo.png"
            alt="Logo"
            class="logo-img"
          />
        ...
        <nav class="sidebar-menu">
          <a href="#">
            <i class="icon">
              <img src="assets/images/dashboard icon.png" alt="Home" />
            </i>
            <span>Dashboard</span>
          </a>
          <a href="#">
            <i class="icon">
              <img src="assets/images/Holy-Bible-icon.png" alt="Bible" />
            </i>
            <span>In the Word</span>
          </a>
          <a href="#">
            <i class="icon">
              <img src="assets/images/study.png" alt="Study & Quizzes" />
            </i>
            <span>Study & Quizzes</span>
          </a>
          <a href="#">
            <i class="icon">
              <img src="assets/images/community3.png" alt="Community" />
            </i>
            <span>Community</span>
          </a>
          <a href="#">
            <i class="icon">
              <img src="assets/images/publish.png" alt="Publish" />
            </i>
            <span>Publish</span>
          </a>
        </nav>
        ...
        <div class="sidebar-footer">
          ...
          <a href="logout.php">
            <i class="icon">
              <img src="assets/images/logout_icon_184325.png" alt="Logout" />
            </i>
            <span>Logout</span>
          </a>
      ...
      <main class="main-content">
        <!-- Topbar -->
        <header class="topbar">
            <!-- Print the user's first name after login -->
  ...
  Welcome, <strong><?php echo htmlspecialchars($firstname); ?></strong> <span class="wave">👋</span>
          ...
          <div class="topbar-actions">
            <div class="search-box">
              ...
              <i class="icon">
                <img src="assets/images/search-icon-png-5.png" alt="Search" />
              </i>
            </div>
            <div class="streak">
              <i class="icon">
                <img
                  src="assets/images/streak vector-pngtree.png"
                  alt="Streak"
                />
              </i>
              <span>2 days</span>
            ...
            <i class="icon">
              <img
                src="assets/images/notification-vector.png"
                alt="Notifications"
              />
            </i>
            <div class="profile-pic">
              <img
                src="assets/images/Lifesavers - Avatar (1).png"
                alt="Profile"
              />
            </div>
          </div>
        ...
        <section class="workspace">
          ...
          <div class="main-boxes">
            <div class="announcement-box inactive">
              <img
                src="assets/images/announcement-3d-icon.webp"
                alt="Announcement"
              />
          ...
          <div class="info-boxes">
            <div class="bible-verse-box inactive">
              <img
                src="assets/images/random bible verses.png"
                alt="Bible Verse"
              />
            ...
            <div class="tips-box inactive">
              <img
                src="assets/images/light-bulb-icon-on-transparent-background-PNG.png"
                alt="Platform Tips"
              />
